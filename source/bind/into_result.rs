/// Tells the [`crate::bind!`] macro whether the given expression yielded a bindable value or an error.
///
/// Enables the [`crate::bind!`] macro to determine by representing the value yielded
